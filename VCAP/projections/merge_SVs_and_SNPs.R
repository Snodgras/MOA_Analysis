...
#This is originally the script "merge_SVs_and_SNPs.R" from Rafa's pipeline
#But I don't need to merge SVs and SNPs for this projection
#However there are other features of this script that do need to be done
