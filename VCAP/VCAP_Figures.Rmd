...
ggplot(H_perm_ALL, aes(y=reorder(Trait,Va_MOA))) + 
  ...
  ggtitle(str_c("Estimated Va of All Traits with 100 Permutations"))+
  theme(legend.title = element_blank())
ggsave("Test_Results_Full/RidgeplotVaALL_MEAN_traitlabeled.png",device = "png")
...
ggplot(H_perm_ALL, aes(y=reorder(Trait,Her_K1))) + 
  ...
  theme(legend.title = element_blank())
ggsave("Test_Results_Full/Ridgeplot.h2.all.traitlabeled.png", device = "png")
...
ggplot(aes(y=bettertraitname)) + 
  ...
  theme(legend.title = element_blank())
ggsave("VitaminE.h2byComponent.ridgeplot.png", device = "png")
```
